...
these points, using the weight and bias values above.](https://developers.google.com/static/machine-learning/crash-course/linear-regression/images/parameters-exercise-solution.png)