...
def get_prompt(prompt_type: str = "general") -> str:
    ...
    prompts = {
        ...
        "code_review": "다음코드를 검토하고 개선점을 제안해 주세요. 코드의 가독성, 성능, 보안 측면을 고려해 주세요.",
...
@mcp.resource("simple://info")#resource define
def get_server_info():
    """서버 정보 반환 도구"""
    return """
Simple MCP Server 정보
이서버는 MCP(Model Context Protocol)의 기본기능을 시연하는 간단한 예제 입니다.
...
if __name__ == "__main__":
    mcp.run(transport="streamable-http") #localhost:8000/mcp